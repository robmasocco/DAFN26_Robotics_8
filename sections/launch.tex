...
\begin{frame}{Launch files}
  \justifying
	\textbg{Launch files} are \textbg{Python scripts} that specify how ROS 2 modules must be \textbg{located}, \textbg{configured} and \textbg{started}. Their format is such that the Launch System can parse and integrate them when invoked.\\
  \bigskip
	...
	\end{itemize}
	\bigskip
	It is also possible to start \textbg{custom executables}, define \textbg{environment variables}, and more.\\
  \bigskip
